    ...
    <div class="col-lg-9">
        <div class="card">
            <div class="card-header">
                ...
                <a class="float-right text-danger" href="{{ route('tag-product.index') }}">Back To Home<i class="fa fa-arrow-right"></i></a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                           @forelse ($product_trash as $trash)
                               <tr>
                                    ...
                                    <td>
                                    @if ($trash -> trash)
                                        <a class="" href="{{ route('product.tag.trash.update',$trash -> id,) }}"><span class="badge badge-info">Restore User</span></a>
                                    @endif
                                </td>
                                <td>
                                    <form  class="d-inline" action="{{ route('tag-product.sdestroy',$trash -> id ) }}" method="post">
                                        @csrf
                                        @method('DELETE')
