    ...
    <div class="col-lg-9">
        <div class="card">
            <div class="card-header">
                ...
                <a class="float-right text-danger" href="{{ route('contact-admin.index') }}">Trash <i class="fa fa-arrow-right"></i></a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                           @forelse ($all_trash as $trash)
                               <tr>
                                    ...
                                    <td>
                                    @if ($trash -> trash)
                                        <a class="" href="{{ route('con.trash.update',$trash -> id,) }}"><span class="badge badge-info">Restore User</span></a>
                                    @endif
                                </td>
                                <td>
                                    <form  class="d-inline" action="{{ route('contact-admin.destroy',$trash -> id ) }}" method="post">
                                        @csrf
                                        @method('DELETE')
