    ...
    <div class="col-lg-9">
        <div class="card">
            <div class="card-header">
                ...
                <a class="float-right text-danger" href="{{ route('portfolio-banner.index') }}">Trash <i class="fa fa-arrow-right"></i></a>
            </div>
            <div class="card-body">
                    ...
                    <table class="table mb-0 data-table-ov">
                        ...
                        <tbody>
                            @foreach ($port_trash as $trash)
                                ...
                                <td>
                                    @if ($trash -> trash)
                                        <a href="{{ route('portbanner.trash.update',$trash -> id,) }}"><span class="badge badge-info">Restore User</span></a>
                                    @endif
                                </td>
                                <td>
                                    <form  class="d-inline" action="{{ route('portfolio-banner.destroy',$trash -> id ) }}" method="post">
                                        @csrf
                                        @method('DELETE')
